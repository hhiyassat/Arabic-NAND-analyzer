"""old_nand_coordinate.py — تجربة "old_nand" — إحداثيّة hash 6-level.

⚠️  هذا تجربة مُسَجَّلة، لا مُكَوِّن دستوريّ.
    اقرأ archive/old_nand/LESSON.md قبل الاعتماد عليها.

السبب في الإبقاء: حتى نَتذكَّر التَّجريد الذي بَنَيناه ثم رَجَعنا عنه عند اختبار
"الحد الأدنى المكتمل". لا يَنبني على هذه الإحداثيّة شيء جوهريّ في النظام؛
المعلومات الحقيقيّة في TokenI3rab.{word_class, root, wazn, case_id, mark_id,
role_phrase, contracts...}.

تَبقى الـ APIs مَوسومة بـ ``old_nand_*`` لِيَكون واضحًا أنّها تَجربة:
  TokenI3rab.old_nand_path    — نصّ المسار بـ 6 مستويات
  TokenI3rab.old_nand_hash    — hash 24 hex (96 bit)
