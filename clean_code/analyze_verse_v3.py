        ...
        for q in questions:
            ...
            if _q.startswith("مَن الفاعِل"):
                ...
                if a.kind == "Certificate":
                    _explain("استُخرِج جَواب الشَّرط مِن حافَة jawab_shart_of "
                            "في L4؛ هذا تَركيب نَحوي وَ ليس تَفسيرًا.")
                elif a.kind == "Zero":
                    _explain("لا تُوجَد حافَة jawab_shart_of آمِنَة في شَبَكَة "
                            "المَعنى؛ النِّظام يُفَضِّل عَدَم اختِلاق جَواب.")
            elif "تَحَوَّل" in _q:
                if a.kind == "Zero":
