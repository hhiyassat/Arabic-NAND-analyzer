...
class TextGraphAssembler:
    ...
    def __init__(self) -> None:
        ...
        self._pronoun_resolver = PronounCliticResolver()
    ...
    def assemble(self, text: str) -> TextGraph:
        ...
        # cross_clause_nouns: list of (global_id, surface, gender_hint)
        cross_clause_nouns: list[tuple[str, str]] = []

        # 2-3-5. لِكُلّ جُملة: i3rab + relations + ضَمائر
        for ci, clause in enumerate(clauses):
            ...
            # ضَمائر — تَحويل الفَهارِس لِـ global ids
            for pref in pronoun_refs:
                ...
                if pref.referent_token_idx is not None:
                    ...
                    # cross-clause fallback: ابحَث في الجُمَل السَّابِقَة
